...
<template>
  <div class="bg-white border-b-2 border-dark px-3">
    <div class="container flex justify-between">
      <NuxtLink to="/" class="text-2xl sm:text-3xl flex items-center">MetaWall</NuxtLink>
      <div class="relative ">
        <button class="flex py-3" @click="toggleList">
          <img src="" alt="" class="h-[30px] w-[30px] rounded-full border-2 border-black mr-2">
          <div class="p-1 border-b-2 border-dark text-base leading-5">Member</div>
        </button>
