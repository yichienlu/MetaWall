...
<template>
  <div class="bg-white rounded-lg p-6 border-2 border-dark shadow-[0_3px_0_0_#000400]">
    ...
    <div class="flex mt-4 items-center">
      <button class="mr-2 text-dark-gray hover:text-dark" :class="{'text-primary':post.liked}"><Icon name="material-symbols:thumb-up-outline" class="w-6 h-6 " /></button>
      <span class="text-dark-gray" v-if="post.likes==0">成為第一個按讚的朋友</span>
